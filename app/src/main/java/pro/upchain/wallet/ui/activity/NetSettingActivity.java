...
import static pro.upchain.wallet.C.WINCHAIN_NETWORK_NAME;
...
public class NetSettingActivity extends BaseActivity {
    ...
    @BindView(R.id.iv_winchain)
    ImageView ivWinchain;
    ...
    public void initDatas() {
        ...
        if (ETHEREUM_MAIN_NETWORK_NAME.equals(networkName)) {
            ...
            ivWinchain.setVisibility(View.GONE);
            ...
            ivWinchain.setVisibility(View.GONE);
        } else if (WINCHAIN_NETWORK_NAME.equals(networkName)) {
            ivMainnet.setVisibility(View.GONE);
            ivKovan.setVisibility(View.GONE);
            ivRopsten.setVisibility(View.GONE);
            ivLocalDev.setVisibility(View.GONE);
            ivWinchain.setVisibility(View.VISIBLE);
        }
    }
    ...
    @OnClick({R.id.rl_mainnet, R.id.rl_kovan, R.id.rl_ropsten, R.id.rl_local_dev, R.id.rl_winchain, R.id.rl_btn})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.rl_ropsten:
                ...
                break;
            case R.id.rl_winchain:
                networkName = WINCHAIN_NETWORK_NAME;
                ivMainnet.setVisibility(View.GONE);
                ivKovan.setVisibility(View.GONE);
                ivRopsten.setVisibility(View.GONE);
                ivWinchain.setVisibility(View.VISIBLE);
